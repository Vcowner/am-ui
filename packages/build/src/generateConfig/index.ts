/*
 * @Author: liaokt
 * @Description: 获取构建配置的主方法
 * @Date: 2023-10-16 14:09:28
 * @LastEditors: liaokt
 * @LastEditTime: 2023-10-17 16:27:56
 */
// packages/build/src/generateConfig/index.ts
import { mergeConfig, UserConfig } from 'vite';
import { PackageJson } from 'type-fest';
import { readJson, absCwd } from '../utils';
...
export async function generateConfig(
  ...
  const packageJson = await readJson<PackageJson>(absCwd('package.json'));
